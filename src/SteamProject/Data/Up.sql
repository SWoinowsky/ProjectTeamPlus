...
ALTER TABLE [CompetitionPlayer]			 ADD CONSTRAINT [CompetitionPlayer_Fk_User]					FOREIGN KEY ([SteamId])			REFERENCES [User] ([SteamId])		ON DELETE CASCADE	ON UPDATE NO ACTION;
